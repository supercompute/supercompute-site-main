...
// Self-contained wallet stack — providers + button in one module.
// Dynamically imported in Sidebar with ssr: false so:
//   1. It never runs during SSR or hydration
//   2. The WagmiProvider mounts ONCE and stays stable across navigation
//   3. No wallet request fires until the user explicitly clicks the button
...
const config = getDefaultConfig({
  ...
  chains: [base],
  ssr: false, // no auto-reconnect from localStorage on mount
});

// Module-level singletons — never re-created on navigation
